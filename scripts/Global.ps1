...
.\scripts\generate-csv-pass2u.ps1
#.\scripts\New-QRCode.ps1 -SourceDir ".\contacts" -OutputDir ".\qrcodes" -Filter "*.vcf" -UseFullFileName -AutoDownload -WriteContactsCsv -Force
